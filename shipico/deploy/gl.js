...
var importObject = {
    env: {
        ...
        glUniformMatrix3fv: function (location, count, transpose, value) {
            ...
            assert((value & 3) == 0, 'Pointer to float data passed to glUniformMatrix43v must be aligned to four bytes!');
            var view = getArray(value, Float32Array, 9);
            gl.uniformMatrix3fv(GL.uniforms[location], !!transpose, view);
        },
